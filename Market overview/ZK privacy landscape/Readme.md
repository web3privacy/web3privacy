...
- [Firn Protocol](https://app.firn.cash) - Pluggable, flexible privacy for Ethereum-based chains, with unparalleled efficiency—thanks to a unique _account-based_ architecture ✨️**ZK** ([GitHub](https://github.com/firnprotocol))
...
- [Dusk](https://dusk.network) - Is a permissionless, ZK-friendly L1 blockchain protocol focused on Compliance and Privacy to tokenize Real-World Assets natively on-chain. Regulated and Decentralized Finance.([GitHub](https://github.com/dusk-network))
...
- [Charon](https://www.911truth.com) - a privacy enabled, cross-chain AMM and stable token system([Github](https://www.github.com/charonAMM))
...
- [Plebble](https://plebble.net) - P2P Network of computers running the Plebble software (L1 & L2). Plebble is an R&D Project on Future Societies started in 2017 in crypto-economic distributed, permissionless, egalitarian, scalable, privacy-preserving, sovereign, AI-aided P2P networks; enabling untraceable, fast and reliable value-transfer for anyone; plus, at the same time, serving as a foundation for a projected poorless/poverty-oblivious un{controlled/surveyed/regulated} civilization based on a better social order with no central authority, no 3rd parties nor intermediaries.  ([GitHub](https://github.com/root1m3/plebble))
