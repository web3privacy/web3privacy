...
**Nighthawk Wallet**	"It’s been a while since @NighthawkWallet APK was analyzed for privacy concerns. Feel free to test it at 
...
**Hideyour.cash** We’re on the process to conduct a security audit with a full report when going to mainnet.	Our code is open source in case you wanna ask someone from your trust.				

**Spook**	"If you’re non technical you won’t be able to verify it yourself.
