...
| [Aleph Zero](https://alephzero.org) | Privacy-enhancing blockchain and a shielder network deployed on multiple EVM networks. Client-side ZK privacy with proofs generated in less than a second. | [Github](https://github.com/Cardinal-Cryptography) | mainnet | multichain, Aleph Zero | [Public](https://alephzero.org/the-team) |
