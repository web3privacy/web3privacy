...
| [Haveno](https://haveno.exchange) | Decentralized P2P exchange for Monero and fiat currencies, using 2-of-3 multisig escrow and Tor for privacy. Most popular Monero DEX with multiple community instances (RetosSwap, DawnSwap). AGPL-3.0. | [Github](https://github.com/haveno-dex/haveno) | live | Monero | anon | [Docs](https://haveno.exchange/docs/) | - |
