...
| [Olares](https://www.olares.xyz/) | Olares is the sovereign cloud that puts you in control. It's an open-source, self-hosted alternative to public clouds like AWS, built to reclaim your data ownership and privacy.  | [GitHub](https://github.com/beclab/Olares) | - | - | - |
