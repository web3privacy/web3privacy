...
| [Vector](https://vectorapp.io) | Free, open-source privacy messenger with end-to-end encryption for private messages and group chats. Decentralized, Censorship-Resistant, No Metadata Tracking, and no KYC. | [GitHub](https://github.com/VectorPrivacy/Vector) | Open Beta (July 2025) | Nostr | [Anon & Public](https://explorer.web3privacy.info/project/vector-privacy) |
